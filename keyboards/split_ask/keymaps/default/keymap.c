...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_FUNC] = LAYOUT_kc(
    ...
    //|------+------+------+------+------+------|            |------+------+------+------+------+------+------+---------|
           _____, _____, _____, _____, _____, _____,              _____, _____, _____, _____, _____,    UP, _____,RETURN,\
    //|---------+------+------+------+------+------|            |------+------+------+------+------+------+------+      |
             _____,  VOLD,  VOLU,  MUTE, _____, _____,              _____, _____, _____, _____,  LEFT,  RGHT,            \
    //|-----------+------+------+------+------+------|            |------+------+------+------+------+------+-----------|
                _____, _____, _____, _____, _____, _____,              _____, _____, _____, _____,  DOWN,          _____,\
    //|--------------+------+------+------+------+------|--------.   |------+------+------+------+------+---------------|
