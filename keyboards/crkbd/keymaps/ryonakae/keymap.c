...
#define KC_LMP   RGB_MODE_PLAIN
#define KC_LMB   RGB_MODE_BREATHE
#define KC_LMR   RGB_MODE_RAINBOW
#define KC_LMSW  RGB_MODE_SWIRL
#define KC_LMSN  RGB_MODE_SNAKE
#define KC_LMK   RGB_MODE_KNIGHT
#define KC_LMX   RGB_MODE_XMAS
#define KC_LMG   RGB_MODE_GRADIENT
#define KC_LMT   RGB_MODE_RGBTEST
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RAISE] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
      _____,  EXLM,    AT,  HASH,   DLR,  PERC,                   CIRC,  AMPR,  ASTR,  LPRN,  RPRN,   DEL,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
  ...
  [_ADJUST] = LAYOUT_kc( \
  //,-----------------------------------------.                ,-----------------------------------------.
        RST,  LRST, XXXXX, XXXXX, XXXXX, XXXXX,                    LMP,   LMB,   LMR,  LMSW,  LMSN, XXXXX,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
       LTOG,  LHUI,  LSAI,  LVAI, XXXXX, XXXXX,                    LMK,   LMX,   LMG,   LMT, XXXXX, XXXXX,\
  //|------+------+------+------+------+------|                |------+------+------+------+------+------|
